...
const Register = (props: Props) => {
    ...
    const isValidateRegister = () => {
        return state.email.length > 0 && state.password.length > 0 && state.retypePassword.length > 0
    ...
    return (
        <SafeAreaView style={[style.container, styles.paddingVertical10]}>
            ...
            >
                <View style={[styles.alignSpace, styles.marginBottom10, styles.maginHorizontal15 ,style.flex25]}>
                ...
                <View style={[style.registrationFrame, styles.maginHorizontal10, style.flex55]}>
                    <View>
                        ...
                        <TextInput
                            ...
                            onChangeText={(emailInput: string) => {
                                if (isValidEmail(emailInput) === false) {
                                    setState({ ...state, email: emailInput, errorEmail: 'email không đúng định dạng' });
                                } else {
                        ...
                        />
                        <Text style={[style.textError, styles.marginBottom5]}>{state.errorEmail}</Text>
                    </View>
                    <View>
                    ...
                    <TouchableOpacity
                        style={[style.loginButton, style.top20,
                            { backgroundColor: isValidateRegister() === true ? colors.blueMain : colors.inActive },
                            ]}
